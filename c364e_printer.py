...
def get_printer_count(year, month, day, cycle, black_start_num, black_month_num, color_start_num, color_month_num):
    ...
    # 打印机当前总计、黑色、彩色的计数器数量
    all_cur_count = int(str(list[40]))
    black_cur_count = int(str(list[41]))
    color_cur_count = int(str(list[42]))
...
if __name__ == '__main__':
    ...
    inipath = os.path.join(curpath, "c364e_printer.ini")
